...
function(connextdds_add_example)
    ...
    message(STATUS "[INFO] DEPENDENCIES: " ${_CONNEXT_DEPENDENCIES})
...
function(connextdds_add_application)
    ...
    message(STATUS "[info] _CONNEXT_DEPENDENCIES is : " ${_CONNEXT_DEPENDENCIES})
    message(STATUS "[info] CMAKE_CURRENT_BINARY_DIR is : " ${CMAKE_CURRENT_BINARY_DIR})
