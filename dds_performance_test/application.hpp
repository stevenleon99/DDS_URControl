    ...
    while (arg_processing < argc) {
        if ((argc > arg_processing + 1)
            ...
            arg_processing += 2;
                ...
                && (strcmp(argv[arg_processing], "-tr") == 0
                || strcmp(argv[arg_processing], "--topicread") == 0)) {
            topic_read = argv[arg_processing + 1];
            std::cout << "input topic_read is: " << topic_read << std::endl;
            arg_processing += 2;
        } else if ((argc > arg_processing + 1)
                && (strcmp(argv[arg_processing], "-tw") == 0
                || strcmp(argv[arg_processing], "--topicwrite") == 0)) {
